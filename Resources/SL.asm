...
DriveLoop:	
		...
		lda	#$20
ClrScrn:	
		sta	$3c00,x				//Clear screen RAM @ $3c00
...
SkipWarn:
		...
		ldx	#<NDWEnd-NDW
NDLoop:
		lda	NDW-1,x				//No drive, show message and finish
		jsr	$ffd2
		dex
		bne	NDLoop
...
NextLine:
		lda	$d012				//Based on J0x's solution for NTSC detection from CodeBase64.org
SameLine:
		cmp	$d012
		beq	SameLine
		bmi	NextLine
...
BitSLoop:
		adc	#$e7				//2	A=#$35+#$e7+C=#$1c/#$1d A&X=#$18 and C=1 after addition in first pass, C=0 in all other passes
...
BusLock:
		lda	#busy				//2	(A=#$f8) worst case, last bit is read by the drive on the first cycle of LDA
		sta	$dd00				//4	Bus lock
...
FarMatch:
		beq	Sparkle_LoadFetched	//A=#$00 -> End of Block, load next one
		//cmp	#$08
		//beq	EndOfBundle
...
EndOfBundle:	dex				//Or finish bundle (A=#$00)
		stx	Buffer+$ff
Set01:		lda	#$35
		sta	$01
Done:		rts
