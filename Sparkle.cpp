...
void PrintScriptTemplate()
{
    ...
    cout << "HSFile:\tfilepath\\hsfilename.bin\tabcd\tabcdabcd\tabcd\t#(address) (offset) (length) omit it if not needed\n";
    cout << "ProdID:\tabcdef\t\t\t\t\t\t\t#6-digit hex number, first disk only, autogenerated if omitted\n";
    ...
    cout << "ZP:\t02\t\t\t\t\t\t\t#02-fd, first disk only, default: 02 if omitted\n\n";
    ...
    cout << "#Bundle 1 (bundles must be separated by at least one empty line!)\n";
